...
> 隶属：[神圣规划](aimon.md)
>
> 本文档从**用户视角**描述派蒙与用户的交互时间线：在三条路径（闲聊 / skill / 四影）下，用户在 WebUI 和 QQ 分别会看到哪些消息、以什么样的节奏送达。
>
> 实施情况见各模块 docs。
...
├ [浅灰] 🚀 已派发 6 个子任务执行：
│          1. 生执·spec · 起草分析框架
│          2. 死执·review_spec · 审 spec
│          3. 生执·design · 列数据获取 + 计算步骤
│          4. 死执·review_design · 审 design
│          5. 生执·code · 拉数据 + 写分析脚本
│          6. 死执·review_code · 审 code
