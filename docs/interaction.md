...
**Web**：
```
┌ [浅灰] 收到任务：分析 xx 股票走势并写建议。task=abc12345，预计 3-8 分钟。
├ [浅灰] 🔒 安全审查通过
├ [浅灰] 🧭 已编排 5 个子任务，已授权
├ [浅灰] 🚀 已派发 5 个子任务执行：
│          1. 草神 · 收集财报数据
...
│          4. 草神 · 撰写投资建议
│          5. 时执 · 归档产物
│        如超过几分钟未完成，可随时去 /tasks 面板查看进度。
├ ——（七神执行中，静默超 25s 触发 watchdog 浅灰提示）——
└ [正文] 🎉 完成｜
        摘要：xx 股票近期...
        ---
        共 2 轮迭代 | ~$0.12 · 🧠 ...
...
同时：📨 推送会话收到完整摘要；/tasks 面板这条任务状态从"进行中 (round 2/3)"变为"完成"。

**QQ**：
```
[seq 1] 收到任务：分析 xx 股票走势并写建议。task=abc12345，预计 3-8 分钟。
[seq 2] 🔒 安全审查通过
[seq 3] 🧭 已编排 5 个子任务，已授权
[seq 4] 🚀 已派发 5 个子任务执行：
        1. 草神 · 收集财报数据
        2. 草神 · 分析走势
        3. 水神 · 评审方案
