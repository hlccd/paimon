...
- [ ] **七神 B 类空壳节点新职能安排**（v7 解耦后产物，2026-05-08）
  - **现状**：四影 / 七神 / 工人三层结构经 v7 重构后，工人概念彻底取消，2 个节点 archon 本体暂无具体职能：
    - `paimon/archons/raiden.py`：原写代码 4 件套已转生执 produce_design / produce_code / simple_run（simple_code）
    - `paimon/archons/mavuika.py`：原 exec tool-loop 已转生执 simple_run("exec")
...
> v7 重构后体量变化：archons/ -1300 行（七神瘦身，v6）+ shades/worker/ -1330 行（v7 删除）+ shades/{naberius,jonova,istaroth} +1500 行（v7 接管工人职能）+ core/safety/ +400 行（接死执原职能）= 总体净瘦身。
